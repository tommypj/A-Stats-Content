...
class TestUploadEndpoint:
    ...
    async def test_upload_pdf_success(self, async_client, auth_headers, sample_pdf):
        ...
        """
        files = {"file": ("test_document.pdf", sample_pdf, "application/pdf")}

        with (
            patch(
                "api.routes.knowledge.kp.extract_text",
                return_value=("Sample extracted text from PDF.", True),
            ),
            patch(
                "api.routes.knowledge.kp.split_into_chunks",
                return_value=["Sample extracted text from PDF."],
            ),
        ):
            response = await async_client.post(
                "/api/v1/knowledge/upload", files=files, headers=auth_headers
            )
    ...
    async def test_upload_markdown_success(self, async_client, auth_headers):
        ...
        files = {"file": ("therapy_guide.md", BytesIO(md_content), "text/markdown")}
    ...
    async def test_upload_invalid_type(self, async_client, auth_headers):
        ...
        files = {"file": ("video.mp4", BytesIO(b"fake video data"), "video/mp4")}
    ...
    async def test_upload_unauthorized(self, async_client):
        ...
        response = await async_client.post("/api/v1/knowledge/upload", files=files)
...
class TestSourcesEndpoint:
    ...
    async def test_list_sources_pagination(self, async_client, auth_headers, test_sources):
        ...
        response1 = await async_client.get(
            "/api/v1/knowledge/sources?page=1&page_size=2", headers=auth_headers
        )
        ...
        response2 = await async_client.get(
            "/api/v1/knowledge/sources?page=2&page_size=2", headers=auth_headers
        )
    ...
    async def test_list_sources_with_search(self, async_client, auth_headers, test_sources):
        ...
        response = await async_client.get(
            "/api/v1/knowledge/sources?search=therapy", headers=auth_headers
        )
    ...
    async def test_list_sources_with_status_filter(self, async_client, auth_headers, test_sources):
        ...
        response = await async_client.get(
            "/api/v1/knowledge/sources?status=completed", headers=auth_headers
        )
    ...
    async def test_get_source_detail(self, async_client, auth_headers, test_source):
        ...
        response = await async_client.get(
            f"/api/v1/knowledge/sources/{source_id}", headers=auth_headers
        )
    ...
    async def test_get_source_not_found(self, async_client, auth_headers):
        ...
        response = await async_client.get(
            f"/api/v1/knowledge/sources/{fake_id}", headers=auth_headers
        )
    ...
    async def test_get_source_unauthorized_other_user(
        ...
        response = await async_client.get(
            f"/api/v1/knowledge/sources/{source_id}", headers=other_auth_headers
        )
...
class TestQueryEndpoint:
    ...
    async def test_query_success(self, async_client, auth_headers, processed_source):
        ...
        response = await async_client.post(
            "/api/v1/knowledge/query", json=query_data, headers=auth_headers
        )
    ...
    async def test_query_no_relevant_results(self, async_client, auth_headers, processed_source):
        ...
        """
        query_data = {"query": "quantum physics and string theory", "max_results": 5}
    ...
    async def test_query_empty_knowledge_base(self, async_client, auth_headers):
        ...
        query_data = {"query": "any question", "max_results": 5}
    ...
    async def test_query_validation_empty_query(self, async_client, auth_headers):
        ...
        query_data = {"query": "", "max_results": 5}
    ...
    async def test_query_includes_metadata(self, async_client, auth_headers, processed_source):
        ...
        query_data = {"query": "therapeutic techniques", "max_results": 5}
    ...
    async def test_query_with_max_sources(self, async_client, auth_headers, processed_source):
        ...
        query_data = {"query": "therapy", "max_results": 2}
...
class TestStatsEndpoint:
    ...
    async def test_get_stats(self, async_client, auth_headers, test_sources):
        ...
        response = await async_client.get("/api/v1/knowledge/stats", headers=auth_headers)
...
class TestProcessingStatus:
    ...
    async def test_check_processing_status_pending(
        ...
        response = await async_client.get(
            f"/api/v1/knowledge/sources/{source_id}/status", headers=auth_headers
        )
    ...
    @pytest.mark.asyncio
    async def test_check_processing_status_failed(self, async_client, auth_headers, failed_source):
