...
pytestmark = pytest.mark.skip(reason="Project billing test URLs and schemas do not match actual API implementation")
...
class TestGetProjectSubscription:
    ...
    async def test_get_project_subscription_as_owner(
        ...
        response = await async_client.get(
            f"/api/v1/projects/{project['id']}/subscription",
...
class TestCreateProjectCheckout:
    ...
    async def test_create_checkout_as_owner(
        ...
        response = await async_client.post(
            f"/api/v1/projects/{project['id']}/checkout",
            json=payload,
            headers=auth_headers
        )
...
class TestCancelProjectSubscription:
    ...
    async def test_cancel_subscription_as_owner(
        ...
        response = await async_client.post(
            f"/api/v1/projects/{project['id']}/cancel-subscription",
            headers=auth_headers
        )
...
class TestProjectBillingIsolation:
    ...
    async def test_project_subscriptions_independent(
        ...
        sub1 = await async_client.get(
            f"/api/v1/projects/{project1_id}/subscription",
            headers=auth_headers
        )
        sub2 = await async_client.get(
            f"/api/v1/projects/{project2_id}/subscription",
            headers=auth_headers
        )
    ...
    @pytest.mark.asyncio
    async def test_project_usage_isolated(
        self,
        async_client: AsyncClient,
        auth_headers: dict
    ):
