...
def upgrade() -> None:
    op.create_table(
        ...
        ),  # position_drop, traffic_drop, ctr_drop, impressions_drop
        ...
        sa.Column(
            "metric_name", sa.String(50), nullable=False
    ...
    op.create_index(
        "ix_content_decay_alerts_user_type", "content_decay_alerts", ["user_id", "alert_type"]
    )
    op.create_index(
        "ix_content_decay_alerts_unread", "content_decay_alerts", ["user_id", "is_read"]
    )
