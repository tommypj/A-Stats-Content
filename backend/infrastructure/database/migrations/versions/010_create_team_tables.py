...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "subscription_status", sa.String(length=50), nullable=False, server_default="active"
        ),
    ...
    op.add_column(
        "users", sa.Column("current_team_id", postgresql.UUID(as_uuid=False), nullable=True)
    )
