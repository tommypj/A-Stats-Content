...
export const config = {
  ...
  matcher: [
    "/((?!api|_next|_vercel|.*\\..*|dashboard|outlines|articles|images|social|analytics|knowledge|projects|settings|help|admin|content-calendar|keyword-research|billing|invite).*)",
  ],
};
