...
export function TransferOwnershipModal({
  ...
  return (
    <Dialog isOpen={isOpen} onClose={onClose} title="Transfer Team Ownership">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-yellow-800">
                Transferring ownership is permanent. You will lose owner privileges and become an Admin. The new owner will have full control over the team, including the ability to remove you.
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          {eligibleMembers.length === 0 ? (
            <p className="text-sm text-text-muted">
              No eligible members found. Only Admins and Members can become team owners.
            </p>
          ) : (
