...
import { TeamRole, TeamInvitationCreateRequest } from "@/lib/api";
import { Mail, Shield, User as UserIcon, Eye } from "lucide-react";

interface InviteMemberFormProps {
  onInvite: (data: TeamInvitationCreateRequest) => Promise<void>;
}

const roleOptions = [
  { value: "admin" as TeamRole, label: "Admin", icon: Shield, description: "Can manage team members and settings" },
  { value: "member" as TeamRole, label: "Member", icon: UserIcon, description: "Can create and manage content" },
  { value: "viewer" as TeamRole, label: "Viewer", icon: Eye, description: "Can view team content only" },
];
