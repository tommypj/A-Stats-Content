...
export default function AdminOutlinesPage() {
  ...
  const loadOutlines = async () => {
    try {
      ...
      const response = await api.admin.content.outlines(params);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-text-muted mt-1">
            Manage all user-generated outlines
          </p>
        </div>
        <Link
          href="/admin/content"
        ...
        {selectedIds.size > 0 && (
          <div className="mt-4 flex items-center justify-between p-3 bg-red-50 border border-red-200 rounded-lg">
            <p className="text-sm text-red-900">
              {selectedIds.size} outline{selectedIds.size !== 1 ? "s" : ""} selected
            </p>
            <button
      ...
      <div className="bg-white rounded-xl border border-surface-tertiary overflow-hidden">
        {loading ? (
          <div className="p-12 text-center">
            ...
            <p className="mt-4 text-text-muted">Loading outlines...</p>
          </div>
        ) : error ? (
          <div className="p-12 text-center">
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-text-muted">No outlines found</p>
          </div>
        ) : (
          <>
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-surface-tertiary">
                  {outlines.map((outline) => (
                    <tr key={outline.id} className="hover:bg-surface-secondary">
            ...
            <div className="flex items-center justify-between px-4 py-3 border-t border-surface-tertiary">
              <p className="text-sm text-text-muted">
                Showing {(page - 1) * pageSize + 1} to {Math.min(page * pageSize, total)} of {total} outlines
              </p>
