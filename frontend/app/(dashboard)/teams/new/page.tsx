...
import { api, TeamCreateRequest, parseApiError } from "@/lib/api";
...
export default function NewTeamPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to team settings after creation
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div>
        ...
        <div className="mt-4">
          <h1 className="text-2xl font-bold text-text-primary">Create New Team</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <Input
              ...
              required
              disabled={isLoading}
              helperText="Choose a name that describes your team or organization"
            />
          </div>
          ...
          <div>
            <Input
              ...
              helperText={
                <>
                  This will be used in your team URL. Only lowercase letters, numbers, and hyphens.
          ...
          <div>
            <Textarea
              ...
              placeholder="A brief description of what your team does"
              rows={3}
              disabled={isLoading}
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="text-sm text-primary-700 space-y-1 list-disc list-inside">
                  <li>You'll be set as the team owner</li>
                  <li>You can invite members via email</li>
                  <li>Team starts on the Free plan</li>
      ...
      <Card className="p-6 bg-surface-secondary border-none">
        <h3 className="font-semibold text-text-primary mb-3">Tips for team success</h3>
        <ul className="space-y-2 text-sm text-text-secondary">
          <li className="flex items-start gap-2">
            <span className="text-primary-500 font-bold">•</span>
            <span>Choose a clear, descriptive team name that everyone will recognize</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-primary-500 font-bold">•</span>
            <span>Add a description to help new members understand your team's purpose</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-primary-500 font-bold">•</span>
